...
// Roadmaps
const Roadmaps = () => import('@/views/roadmaps/Roadmaps')
const Roadmap = () => import('@/views/roadmaps/Roadmap')
const EditRoadmap = () => import('@/views/roadmaps/EditRoadmap')
const CreateRoadmap = () => import('@/views/roadmaps/CreateRoadmap')

// Regions
const Regions = () => import('@/views/regions/Regions')
const Region = () => import('@/views/regions/Region')
const EditRegion = () => import('@/views/regions/EditRegion')
const CreateRegion = () => import('@/views/regions/CreateRegion')

// Clients
const Clients = () => import('@/views/clients/Clients')
const Client = () => import('@/views/clients/Client')
const EditClient = () => import('@/views/clients/EditClient')
const CreateClient = () => import('@/views/clients/CreateClient')
